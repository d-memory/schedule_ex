<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"C:\phpstudy_pro\WWW\schedule\public/../application/admin\view\schedule\add.html";i:1585615039;s:71:"C:\phpstudy_pro\WWW\schedule\application\admin\view\layout\default.html";i:1585615039;s:68:"C:\phpstudy_pro\WWW\schedule\application\admin\view\common\meta.html";i:1585615038;s:70:"C:\phpstudy_pro\WWW\schedule\application\admin\view\common\script.html";i:1585615038;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-remindtime" data-rule="required" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[remindtime]" type="text" value="<?php echo date('Y-m-d H:i:s'); ?>">
        </div>
    </div>
    <div class="form-group">
